...
@Component({
  ...
  styleUrls: [
    ...
    './principal-responsive.component.scss',
  ],
  animations: [
    trigger('fadeInOut', [
...
export class PrincipalComponent {
  ...
  aboutMeContentComponent: AboutMeContentComponent =
    new AboutMeContentComponent();
  workExperienceContentComponent: WorkExperienceContentComponent =
    new WorkExperienceContentComponent();
  educationContentComponent: EducationContentComponent =
    new EducationContentComponent();
  skillsContentComponent: SkillsContentComponent = new SkillsContentComponent();
  interestsContentComponent: InterestsContentComponent =
    new InterestsContentComponent();
  personalProjectsContentComponent: PersonalProjectsContentComponent =
    new PersonalProjectsContentComponent();
  ...
  getAboutMeTitleContent(): string {
    return this.aboutMeContentComponent.contentByLanguageAboutMeTitle[
      this.selectedLanguage
    ];
  }

  getAboutMeContent(): string {
    return this.aboutMeContentComponent.contentByLanguageAboutMe[
      this.selectedLanguage
    ];
  }
  ...
  getWorkExperienceTitleContent(): string {
    return this.workExperienceContentComponent.contentByLanguageWorkExpTitle[
      this.selectedLanguage
    ];
  }

  getWorkExperienceContent(): WorkExperience[] {
    return this.workExperienceContentComponent.contentByLanguageDevWorkExp[
      this.selectedLanguage
    ];
  }
  ...
  getEducationTitleContent(): string {
    return this.educationContentComponent.contentByLanguageEducationTitle[
      this.selectedLanguage
    ];
  }

  getEducationContent(): Education[] {
    return this.educationContentComponent.contentByLanguageDevEducation[
      this.selectedLanguage
    ];
  }
  ...
  getSkillsTitleContent(): string {
    return this.skillsContentComponent.contentByLanguageSkillsTitle[
      this.selectedLanguage
    ];
  }
  getTypeSkillsContent(): Skills {
    return this.skillsContentComponent.contentByLanguageSkillsType[
      this.selectedLanguage
    ];
  }
  getSoftSkillsContent(): Skills[] {
    return this.skillsContentComponent.contentByLanguageSkillsSoft[
      this.selectedLanguage
    ];
  }

  getHardSkillsContent(): Skills[] {
    return this.skillsContentComponent.contentByLanguageSkillsHard[
      this.selectedLanguage
    ];
  }
  ...
  getInterestsTitleContent(): string {
    return this.interestsContentComponent.contentByLanguageInterestTitle[
      this.selectedLanguage
    ];
  }
  ...
  getPersonalProjectsTitleContent(): string {
    return this.personalProjectsContentComponent
      .contentByLanguagePersonalProjectsTitle[this.selectedLanguage];
  }
